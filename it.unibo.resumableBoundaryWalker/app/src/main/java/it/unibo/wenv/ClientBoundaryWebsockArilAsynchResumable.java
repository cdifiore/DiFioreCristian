...
@ArilRobotSpec
public class ClientBoundaryWebsockArilAsynchResumable {
    ...
    //Constructor
    public ClientBoundaryWebsockArilAsynchResumable(IssOperations rs){
    ...
    public static void main(String args[]){
        try {
            ...
            Object appl = RobotApplicationStarter.createInstance(ClientBoundaryWebsockArilAsynchResumable.class);
            System.out.println("ClientBoundaryWebsockBasicSynch  | appl n_Threads=" + Thread.activeCount());
            String trip = ((ClientBoundaryWebsockArilAsynchResumable)appl).doBoundary();
